...
/// 内核堆的大小
pub const KERNEL_HEAP_SIZE: usize = 0x1000_0000; // 4 MB
/// 用户栈大小
...
/// 表示内存的地址段到此为止
pub const PHYS_MEMORY_END: usize = 0xbf00_0000;
...
pub const DEVICE_START: usize = 0x0000000180200000;
/// 设备映射到内存的最后位置
...
/// 临时文件的大小限制
pub const TMP_SIZE_LIMIT:usize = 0x800_000; // 1 MB

/// 限制 mmap 的最长长度
pub const MMAP_LEN_LIMIT: usize = 0x4000_0000; // 16 MB

#define NGX_CONFIGURE " --with-cc=/opt/riscv/riscv64-linux-musl-cross/bin/riscv64-linux-musl-gcc --with-cpp=/opt/riscv/riscv64-linux-musl-cross/bin/riscv64-linux-musl-cpp --without-http_rewrite_module --without-http_gzip_module --with-cc-opt='-DAO_USE_PTHREAD_DEFS=1 -DNGX_HAVE_MAP_ANON=1 -DNGX_HAVE_LIBATOMIC=1 -DNGX_SYS_NERR=150 -Isrc/libatomic_ops' --with-libatomic --with-ld-opt=-lpthread"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 11.2.1 20211120 (GCC) "
#endif
